$(document).ready(() => {
    ...
    //  선택자:odd          - 홀수 번재에 위치한 요소를 선택 (filter:)
    //  선택자:even         - 짝수 번째 인덱스에 위치한 요소를 선택 (filter:)
    ...
    // 클래스 명이 wrap인 태그의 자손의 자손들의 스타일 변경
